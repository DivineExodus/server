...
public class Forest extends InstanceContainer implements World {
    ...
    Forest() {
        super(UUID.nameUUIDFromBytes("FOREST".getBytes()), DIMENSION);
